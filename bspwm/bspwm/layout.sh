...
if [[ $(xrandr -q | grep "$external_monitor disconnected") ]] then
  ...
  xrdb -merge $HOME/.config/.intern_xr
  ...
  xrandr --output $internal_monitor --mode 3840x2160 --pos 0x2160 --output $external_monitor --primary --mode 3840x2160 --pos 0x0 --rotate normal
  ...
  xrdb -merge $HOME/.config/.extern_xr
