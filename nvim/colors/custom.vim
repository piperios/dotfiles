...
" Blue color is 1a212b
" General Colors
hi Normal       guifg=#d0d0d0   guibg=#1a212b   ctermfg=7      ctermbg=233       gui=none      cterm=none
hi Comment      guifg=#808080   guibg=NONE      ctermfg=2      ctermbg=NONE      gui=none      cterm=none
hi Constant     guifg=#5994ad   guibg=NONE      ctermfg=12     ctermbg=NONE      gui=none      cterm=none
hi Identifier   guifg=#9bb26a   guibg=NONE      ctermfg=10     ctermbg=NONE      gui=none      cterm=none
hi Statement    guifg=#d1b897   guibg=NONE      ctermfg=3      ctermbg=NONE      gui=none      cterm=none
hi PreProc      guifg=#9bb26a   guibg=NONE      ctermfg=10     ctermbg=NONE      gui=none      cterm=none
hi Type         guifg=#9bb26a   guibg=NONE      ctermfg=10     ctermbg=NONE      gui=none      cterm=none
hi Special      guifg=#5994ad   guibg=NONE      ctermfg=12     ctermbg=NONE      gui=none      cterm=none

" Text Markup
hi Underlined   guifg=fg        guibg=NONE      ctermfg=fg     ctermbg=NONE      gui=underline cterm=underline
hi Error        guifg=#ff0000   guibg=NONE      ctermfg=210    ctermbg=NONE      gui=none      cterm=none
hi Todo         guifg=#3a3a3a   guibg=#ffd75f   ctermfg=237    ctermbg=221       gui=none      cterm=none
...
hi Visual       guifg=NONE      guibg=#3a3a3a   ctermfg=NONE   ctermbg=237       gui=none      cterm=none
...
" UI
hi Function     guifg=#d1b897   guibg=NONE      ctermfg=231    ctermbg=NONE      gui=none      cterm=none
hi LineNr       guifg=#d1b897   guibg=#1a212b   ctermfg=3      ctermbg=bg        gui=none      cterm=none
